...
void prueba_simple() {
	int i = 5;
	int j = 16;
	pa2m_afirmar(i == j, "i es igual a j (%d == %d)", i,
			j); // El primer test falla porque i no es igual a j
	pa2m_afirmar(2 * i == 10, "2*i es igual a 2 (%d)", 2 * i);
}

void prueba_creacion_lista() {
	pa2m_nuevo_grupo("Pruebas de creación de la lista simplemente enlazada");
...
void prueba_insertar_en_posicion() {
	...
	pa2m_afirmar(lista_tamanio(lista) == 3, "La lista tiene ahora 3 elementos");

	pa2m_afirmar(!lista_insertar_en_posicion(lista, 10, &cuatro),
...
void prueba_sacar_de_posicion() {
  ...
  pa2m_afirmar(lista_tamanio(lista) == 2, "La lista ahora tiene 2 elementos");
...
void prueba_buscar() {
  pa2m_nuevo_grupo("Pruebas de búsqueda de un elemento según un criterio");
...
void prueba_pila_crear() {
  ...
  pa2m_afirmar(pila_vacia(pila), "La pila está vacía después de ser creada");
...
void prueba_pila_desapilar() {
  ...
  pa2m_afirmar(*(int *)pila_desapilar(pila) == 2, "Se desapiló el elemento 2");
  pa2m_afirmar(*(int *)pila_desapilar(pila) == 1, "Se desapiló el elemento 1");
...
void prueba_pila_tope() {
  ...
  pila_t *pila = pila_crear();
  pa2m_afirmar(pila_tope(pila) == NULL, "El tope de una pila vacía es NULL");
...
void prueba_cola_crear() {
  ...
  pa2m_afirmar(cola_vacia(cola), "La cola está vacía después de ser creada");
